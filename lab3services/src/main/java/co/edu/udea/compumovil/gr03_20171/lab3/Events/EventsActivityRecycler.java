package co.edu.udea.compumovil.gr03_20171.lab3.Events;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(view.getContext(), co.edu.udea.compumovil.gr03_20171.lab3.AddEventsActivity.class);
